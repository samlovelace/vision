...
{
    RosTopicManager::getInstance()->createSubscriber<ptera_msgs::msg::RobotState>(aNavTopicName, 
...
void NavDataHandler::onDataRecvd(ptera_msgs::msg::RobotState::SharedPtr aRobotState)
{
    ...
    ptera_msgs::msg::Vec3 pos = aRobotState->position;
    ptera_msgs::msg::Quaternion q = aRobotState->quat;

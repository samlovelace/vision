...
struct CameraIntrinsics
{
    ...
    // Returns a CV_64F Mat as required by OpenCV pose estimation functions
    // (estimatePoseBoard, solvePnP, etc. require double precision)
    cv::Mat cvCameraMatrix() const
    {
